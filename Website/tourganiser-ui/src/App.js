  ...
  return (
    ...
    <header id="header">
          ...
          <Link to="/about" className="nav-links">About</Link>
					<span onClick={() => setProfileOpen(true)} className='nav-links'>Profile</span>
				</ul>
			</nav>
		</header>
            ...
            <Link to="/about" className="nav-links">About</Link>
				...
				<div className="footer-section">
					...
					<div className="social-links">
						<a href="/" target='_blank' rel='noreferror'><i className="fab fa-discord"></i> Discord</a>
						<a href="https://github.com/tomschulz02/Tournament-Organiser" target='_blank' rel="noreferrer"><i className="fab fa-github"></i> GitHub</a>
					</div>
				</div>
				<div className="footer-section">
					<h4>Contact</h4>
    ...
    <div id="profileTab" className="profile-tab">
			...
			<div className="profile-content">
				...
				<div className="profile-actions">
					...
					<div className="profile-actions-item" id="gotoLogin">Login</div>
					<div className="profile-actions-item" id="logout">Logout</div>
				</div>
			</div>
		</div>
  )
