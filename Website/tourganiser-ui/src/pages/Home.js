	...
	return (
		<div className="home">
			...
			<section id="home">
				...
				<p>
					Tourganiser helps you organise volleyball tournaments in minutes — no spreadsheets, no stress. Customise
					formats, add teams, generate match schedules, and share results — all in one place.
				</p>
				<a href="/tournaments" className="cta-button">
					Get Started
				</a>
			</section>
				...
				<div className="features-grid">
					...
					<div className="feature-card">
						...
						<div className="feature-content">
							...
							<p className="feature-description">
								Keep track of participants, teams, and their statistics. Manage registrations and check-ins smoothly.
							</p>
						</div>
					</div>
					<div className="feature-card">
						...
						<div className="feature-content">
							...
							<p className="feature-description">
								Real-time score updates and bracket progression. Keep everyone informed with instant notifications.
							</p>
						</div>
					</div>
					<div className="feature-card">
